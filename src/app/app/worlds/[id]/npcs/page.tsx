  ...
  async function loadData() {
    ...
    try {
      const [campaignRes, npcRes] = await Promise.all([
        ...
        fetch(`/api/npcs?worldId=${worldId}`, { cache: "no-store" }),
      ]);
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            NPCs deste mundo. Gerencie e adicione ao combate rapidamente.
          </p>
        </div>
        ...
        <EmptyState
          ...
          description={
            hasFilters
              ...
              : "Crie NPCs em uma campanha deste mundo para preencher esta lista."
          }
          action={
            hasFilters ? null : (
