...
async function getSummaries(worldId: string) {
...
export default async function WorldDiaryPage({ params }: PageProps) {
  const { id: worldId } = await params;
  const summaries = await getSummaries(worldId);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Resumo heuristico do log de eventos deste mundo. Preparado para IA futura.
        </p>
      </div>
